...
SELECT
  'ARTICLE',
  '42344792',
  'Haque S, Cavalletto R, Alomshani MA',
  'From Traditional to Eco-Friendly Dentistry: Assessing the Promising Sustainability Outlook in Saudi Arabia.',
  'International journal of dentistry',
  '2026',
  'https://doi.org/10.1155/ijod/9714864',
  0,
  1,
  'Grand test',
  1,
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_publication WHERE pmid='42344792'
);

UPDATE core_publication
SET
  authors = CASE WHEN authors IS NULL OR authors='' THEN 'Haque S, Cavalletto R, Alomshani MA' ELSE authors END,
  title = CASE WHEN title IS NULL OR title='' THEN 'From Traditional to Eco-Friendly Dentistry: Assessing the Promising Sustainability Outlook in Saudi Arabia.' ELSE title END,
  journal = CASE WHEN journal IS NULL OR journal='' THEN 'International journal of dentistry' ELSE journal END,
  publication_date = CASE WHEN publication_date IS NULL OR publication_date='' THEN '2026' ELSE publication_date END,
  url = CASE WHEN url IS NULL OR url='' THEN 'https://doi.org/10.1155/ijod/9714864' ELSE url END,
  reported_TF = CASE WHEN reported_TF IS NULL OR reported_TF='' THEN 'VpsR' ELSE reported_TF END,
  ...
  submission_notes = CASE
    WHEN submission_notes IS NULL OR submission_notes='' THEN 'Grand test'
    ELSE submission_notes
  END
WHERE pmid='42344792';

INSERT INTO core_tf (name, family_id, description)
SELECT 'VpsR', 27, 'VpsR is a two-component response regulator of the vps biosynthetic gene cluster, which plays a role in the formation of biofilms in Vibrio Cholera. [PMID::11160103]'
WHERE NOT EXISTS (
  SELECT 1 FROM core_tf WHERE lower(name)=lower('VpsR')
);

UPDATE core_tf
SET
  family_id = COALESCE(family_id, 27),
  description = CASE WHEN description IS NULL THEN 'VpsR is a two-component response regulator of the vps biosynthetic gene cluster, which plays a role in the formation of biofilms in Vibrio Cholera. [PMID::11160103]' ELSE description END
WHERE lower(name)=lower('VpsR');

INSERT INTO core_tfinstance (refseq_accession, uniprot_accession, description, TF_id, notes)
SELECT
  'WP_002214647',
  'Q0WJZ2',
  'zinc uptake transcriptional repressor [Yersinia pestis biovar Microtus str. 91001].',
  (SELECT TF_id FROM core_tf WHERE lower(name)=lower('VpsR') LIMIT 1),
  ''
WHERE NOT EXISTS (
  SELECT 1 FROM core_tfinstance WHERE uniprot_accession='Q0WJZ2'
);

UPDATE core_tfinstance
SET
  TF_id = COALESCE(TF_id, (SELECT TF_id FROM core_tf WHERE lower(name)=lower('VpsR') LIMIT 1)),
  refseq_accession = COALESCE(NULLIF(refseq_accession,''), 'WP_002214647'),
  description = COALESCE(NULLIF(description,''), 'zinc uptake transcriptional repressor [Yersinia pestis biovar Microtus str. 91001].'),
  notes = COALESCE(notes, '')
WHERE uniprot_accession='Q0WJZ2';
...
VALUES
  ('Helicobacter pylori J99', 'Helicobacter pylori J99', NULL,
   0, NULL, 'Grand test',
   datetime('now'), (SELECT curator_id FROM core_curator ORDER BY curator_id LIMIT 1), (SELECT publication_id FROM core_publication WHERE pmid='42344792' LIMIT 1), datetime('now'), NULL);

INSERT INTO core_curation_TF_instances (curation_id, tfinstance_id)
SELECT (SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42344792' LIMIT 1) ORDER BY curation_id DESC LIMIT 1), (SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='Q0WJZ2' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_curation_TF_instances
  WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42344792' LIMIT 1) ORDER BY curation_id DESC LIMIT 1) AND tfinstance_id=(SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='Q0WJZ2' LIMIT 1)
);
...
SELECT
  (SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1),
  'WP_000911888.1',
  'DUF8569 domain-containing protein',
  277685,
  278668,
  1,
  'JHP_RS01355',
...
SELECT
  ...
  NULL
WHERE NOT EXISTS (
  SELECT 1 FROM core_taxonomy WHERE taxonomy_id='29547'
);

UPDATE core_taxonomy
SET
  rank = COALESCE(NULLIF(rank,''), 'phylum'),
  name = COALESCE(NULLIF(name,''), 'Campylobacterota'),
  parent_id = COALESCE(parent_id, NULL)
WHERE taxonomy_id='29547';
...
SELECT
  ...
  (SELECT id FROM core_taxonomy WHERE taxonomy_id='29547' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_taxonomy WHERE taxonomy_id='3031852'
);

UPDATE core_taxonomy
SET
  rank = COALESCE(NULLIF(rank,''), 'class'),
  name = COALESCE(NULLIF(name,''), 'Epsilonproteobacteria'),
  parent_id = COALESCE(parent_id, (SELECT id FROM core_taxonomy WHERE taxonomy_id='29547' LIMIT 1))
WHERE taxonomy_id='3031852';
...
SELECT
  ...
  'order',
  'Campylobacterales',
  (SELECT id FROM core_taxonomy WHERE taxonomy_id='3031852' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_taxonomy WHERE taxonomy_id='213849'
);

UPDATE core_taxonomy
SET
  rank = COALESCE(NULLIF(rank,''), 'order'),
  name = COALESCE(NULLIF(name,''), 'Campylobacterales'),
  parent_id = COALESCE(parent_id, (SELECT id FROM core_taxonomy WHERE taxonomy_id='3031852' LIMIT 1))
WHERE taxonomy_id='213849';
...
SELECT
  ...
  'family',
  'Helicobacteraceae',
  (SELECT id FROM core_taxonomy WHERE taxonomy_id='213849' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_taxonomy WHERE taxonomy_id='72293'
);

UPDATE core_taxonomy
SET
  rank = COALESCE(NULLIF(rank,''), 'family'),
  name = COALESCE(NULLIF(name,''), 'Helicobacteraceae'),
  parent_id = COALESCE(parent_id, (SELECT id FROM core_taxonomy WHERE taxonomy_id='213849' LIMIT 1))
WHERE taxonomy_id='72293';
...
SELECT
  ...
  'genus',
  'Helicobacter',
  (SELECT id FROM core_taxonomy WHERE taxonomy_id='72293' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_taxonomy WHERE taxonomy_id='209'
);

UPDATE core_taxonomy
SET
  rank = COALESCE(NULLIF(rank,''), 'genus'),
  name = COALESCE(NULLIF(name,''), 'Helicobacter'),
  parent_id = COALESCE(parent_id, (SELECT id FROM core_taxonomy WHERE taxonomy_id='72293' LIMIT 1))
WHERE taxonomy_id='209';
...
SELECT
  ...
  'species',
  'Helicobacter pylori',
  (SELECT id FROM core_taxonomy WHERE taxonomy_id='209' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_taxonomy WHERE taxonomy_id='210'
);

UPDATE core_taxonomy
SET
  rank = COALESCE(NULLIF(rank,''), 'species'),
  name = COALESCE(NULLIF(name,''), 'Helicobacter pylori'),
  parent_id = COALESCE(parent_id, (SELECT id FROM core_taxonomy WHERE taxonomy_id='209' LIMIT 1))
WHERE taxonomy_id='210';

UPDATE core_genome
SET taxonomy_id = (
  SELECT id FROM core_taxonomy WHERE taxonomy_id='210' LIMIT 1
)
WHERE genome_accession='NC_000921.1';

INSERT INTO core_experimentaltechnique (name, description, preset_function, EO_term)
SELECT 'Comparative genomics search', 'Comparative genomics search', NULL, 'ECO:0005622'
WHERE NOT EXISTS (
  SELECT 1 FROM core_experimentaltechnique WHERE EO_term='ECO:0005622'
);
...
WHERE NOT EXISTS (
  ...
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
    AND start=737285 AND end=737293 AND strand=1
    AND _seq='ACTGCACAG'
);
...
VALUES
  ((SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42344792' LIMIT 1) ORDER BY curation_id DESC LIMIT 1),
...
SELECT (SELECT id FROM core_curation_siteinstance
        WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42344792' LIMIT 1) ORDER BY curation_id DESC LIMIT 1)
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      ...
      WHERE locus_tag='JHP_RS03430' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_siteinstance
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
    AND start=420029 AND end=420036 AND strand=1
    AND _seq='GGCACTGA'
);
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='JHP_RS02045' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'inferred',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='JHP_RS02050' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'inferred',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='JHP_RS02055' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'exp_verified',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='JHP_RS02060' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'exp_verified',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='JHP_RS02065' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'inferred',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='JHP_RS02070' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'inferred',
        NULL
      WHERE (SELECT gene_id FROM core_gene
