...
SET
  ...
  reported_TF = CASE WHEN reported_TF IS NULL OR reported_TF='' THEN 'ExpR' ELSE reported_TF END,
...
SELECT 'ExpR', 2, 'ExpR is a member of the LuxR family of proteins. First described in Erwinia chrysanthemi, it is a quorum sensing regulator involved in biosynthesis of pectinases and glucans  [PMID::9781877][PMID::18515420].'
WHERE NOT EXISTS (
  SELECT 1 FROM core_tf WHERE lower(name)=lower('ExpR')
);

UPDATE core_tf
SET
  family_id = COALESCE(family_id, 2),
  description = CASE WHEN description IS NULL THEN 'ExpR is a member of the LuxR family of proteins. First described in Erwinia chrysanthemi, it is a quorum sensing regulator involved in biosynthesis of pectinases and glucans  [PMID::9781877][PMID::18515420].' ELSE description END
WHERE lower(name)=lower('ExpR');
...
SELECT
  ...
  (SELECT TF_id FROM core_tf WHERE lower(name)=lower('ExpR') LIMIT 1),
  ''
WHERE NOT EXISTS (
...
SET
  TF_id = COALESCE(TF_id, (SELECT TF_id FROM core_tf WHERE lower(name)=lower('ExpR') LIMIT 1)),
...
SELECT (SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42148648' LIMIT 1) ORDER BY curation_id DESC LIMIT 1), (SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='Q03AX7' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_curation_TF_instances
  WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42148648' LIMIT 1) ORDER BY curation_id DESC LIMIT 1) AND tfinstance_id=(SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='Q03AX7' LIMIT 1)
);
...
WHERE NOT EXISTS (
  ...
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000907.1' LIMIT 1)
    AND start=12 AND end=17 AND strand=1
    AND _seq='AATTGG'
);
...
SELECT
  ...
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HI_RS00005' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000907.1' LIMIT 1)
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_siteinstance
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000907.1' LIMIT 1)
    AND start=198 AND end=203 AND strand=1
    AND _seq='GGTTAA'
);
