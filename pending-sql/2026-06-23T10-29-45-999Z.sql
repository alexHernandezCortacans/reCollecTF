...
SELECT
  'ARTICLE',
  '42327937',
  'Dhayalan M, Chenna Reddy M, Arumugam MK, Liana D, Ng BW, Phanumartwiwath A',
  'Eco-Friendly Engineered Ternary Nanocomposite for Label-Free Fluorescent SARS-CoV‑2 N‑Gene DNA Detection.',
  'ACS nanoscience Au',
  '2026 Jun 17',
  'https://doi.org/10.1021/acsnanoscienceau.5c00179',
  0,
  1,
  'Test for db evidence_type',
  1,
  'LexA',
  'Helicobacter pylori 26695'
WHERE NOT EXISTS (
  SELECT 1 FROM core_publication WHERE pmid='42327937'
);

UPDATE core_publication
SET
  authors = CASE WHEN authors IS NULL OR authors='' THEN 'Dhayalan M, Chenna Reddy M, Arumugam MK, Liana D, Ng BW, Phanumartwiwath A' ELSE authors END,
  title = CASE WHEN title IS NULL OR title='' THEN 'Eco-Friendly Engineered Ternary Nanocomposite for Label-Free Fluorescent SARS-CoV‑2 N‑Gene DNA Detection.' ELSE title END,
  journal = CASE WHEN journal IS NULL OR journal='' THEN 'ACS nanoscience Au' ELSE journal END,
  publication_date = CASE WHEN publication_date IS NULL OR publication_date='' THEN '2026 Jun 17' ELSE publication_date END,
  url = CASE WHEN url IS NULL OR url='' THEN 'https://doi.org/10.1021/acsnanoscienceau.5c00179' ELSE url END,
  ...
  submission_notes = CASE
    WHEN submission_notes IS NULL OR submission_notes='' THEN 'Test for db evidence_type'
...
SELECT
  'WP_002212297',
  'Q7CFV3',
  'cAMP-regulatory protein [Yersinia pestis KIM10+].',
  (SELECT TF_id FROM core_tf WHERE lower(name)=lower('LexA') LIMIT 1),
  ''
WHERE NOT EXISTS (
  SELECT 1 FROM core_tfinstance WHERE uniprot_accession='Q7CFV3'
);

UPDATE core_tfinstance
SET
  TF_id = COALESCE(TF_id, (SELECT TF_id FROM core_tf WHERE lower(name)=lower('LexA') LIMIT 1)),
  refseq_accession = COALESCE(NULLIF(refseq_accession,''), 'WP_002212297'),
  description = COALESCE(NULLIF(description,''), 'cAMP-regulatory protein [Yersinia pestis KIM10+].'),
  notes = COALESCE(notes, '')
WHERE uniprot_accession='Q7CFV3';
...
VALUES
  ('Helicobacter pylori 26695', 'Helicobacter pylori 26695', NULL,
   0, NULL, 'Test for db evidence_type',
   datetime('now'), (SELECT curator_id FROM core_curator ORDER BY curator_id LIMIT 1), (SELECT publication_id FROM core_publication WHERE pmid='42327937' LIMIT 1), datetime('now'), NULL);

INSERT INTO core_curation_TF_instances (curation_id, tfinstance_id)
SELECT (SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42327937' LIMIT 1) ORDER BY curation_id DESC LIMIT 1), (SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='Q7CFV3' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_curation_TF_instances
  WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42327937' LIMIT 1) ORDER BY curation_id DESC LIMIT 1) AND tfinstance_id=(SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='Q7CFV3' LIMIT 1)
);
...
WHERE NOT EXISTS (
  ...
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
    AND start=912276 AND end=912282 AND strand=1
    AND _seq='ACTGTCC'
);
...
VALUES
  ((SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42327937' LIMIT 1) ORDER BY curation_id DESC LIMIT 1),
...
SELECT (SELECT id FROM core_curation_siteinstance
        WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42327937' LIMIT 1) ORDER BY curation_id DESC LIMIT 1)
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      ...
      WHERE locus_tag='HP_RS04180' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='HP_RS04185' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'exp_verified',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_siteinstance
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
    AND start=22580 AND end=22585 AND strand=1
    AND _seq='CTGACC'
);
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='HP_RS00125' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'exp_verified',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='HP_RS00130' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'inferred',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_siteinstance
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
    AND start=17994 AND end=17999 AND strand=1
    AND _seq='CAGACA'
);
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='HP_RS00105' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'exp_verified',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='HP_RS00110' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'exp_verified',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='HP_RS00115' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'inferred',
        NULL
      WHERE (SELECT gene_id FROM core_gene
...
INSERT INTO core_regulation (curation_site_instance_id, gene_id, evidence_type, meta_site_id)
      SELECT
        ...
        ORDER BY id DESC LIMIT 1),
        (SELECT gene_id FROM core_gene
      WHERE locus_tag='HP_RS00120' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
      ORDER BY gene_id DESC LIMIT 1),
        'inferred',
        NULL
      WHERE (SELECT gene_id FROM core_gene
