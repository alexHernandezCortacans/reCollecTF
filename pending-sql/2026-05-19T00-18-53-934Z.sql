...
SELECT (SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='41452899' LIMIT 1) ORDER BY curation_id DESC LIMIT 1), (SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='V9UYV3' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_curation_TF_instances
  WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='41452899' LIMIT 1) ORDER BY curation_id DESC LIMIT 1) AND tfinstance_id=(SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='V9UYV3' LIMIT 1)
);
...
WHERE NOT EXISTS (
  ...
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
    AND start=47807 AND end=47814 AND strand=1
    AND _seq='GATAGATA'
);
...
SELECT
  ...
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00240' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_siteinstance
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
    AND start=47808 AND end=47815 AND strand=1
    AND _seq='ATAGATAG'
);
