...
SELECT
  'pubmed',
  '24915082',
  'Sugiyama S, Kashiwagi K, Kakinouchi K, Tomitori H, Kanai K, Murata M, Adachi H, Matsumura H, Takano K, Murakami S, Inoue T, Mori Y, Igarashi K',
  ...
  '2014 Jun',
  'https://doi.org/10.1107/S2053230X14008607',
  0,
  1,
  NULL,
  1,
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_publication WHERE pmid='24915082'
);

UPDATE core_publication
SET
  authors = CASE WHEN authors IS NULL OR authors='' THEN 'Sugiyama S, Kashiwagi K, Kakinouchi K, Tomitori H, Kanai K, Murata M, Adachi H, Matsumura H, Takano K, Murakami S, Inoue T, Mori Y, Igarashi K' ELSE authors END,
  title = CASE WHEN title IS NULL OR title='' THEN 'Crystallization and preliminary crystallographic studies of PotA, a membrane-associated ATPase of the spermidine-preferential uptake system in Thermotoga maritima.' ELSE title END,
  journal = CASE WHEN journal IS NULL OR journal='' THEN 'Acta crystallographica. Section F, Structural biology communications' ELSE journal END,
  publication_date = CASE WHEN publication_date IS NULL OR publication_date='' THEN '2014 Jun' ELSE publication_date END,
  url = CASE WHEN url IS NULL OR url='' THEN 'https://doi.org/10.1107/S2053230X14008607' ELSE url END,
...
SELECT
  'WP_002858684',
  'Q0PBI7',
  'peroxide stress regulator [Campylobacter jejuni subsp. jejuni NCTC 11168 = ATCC 700819].',
  (SELECT TF_id FROM core_tf WHERE lower(name)=lower('LexA') LIMIT 1),
  '',
  ''
WHERE NOT EXISTS (
  SELECT 1 FROM core_tfinstance WHERE uniprot_accession='Q0PBI7'
);

UPDATE core_tfinstance
SET
  TF_id = COALESCE(TF_id, (SELECT TF_id FROM core_tf WHERE lower(name)=lower('LexA') LIMIT 1)),
  refseq_accession = COALESCE(NULLIF(refseq_accession,''), 'WP_002858684'),
  description = COALESCE(NULLIF(description,''), 'peroxide stress regulator [Campylobacter jejuni subsp. jejuni NCTC 11168 = ATCC 700819].'),
  notes = COALESCE(notes, ''),
  GO_term_id = COALESCE(GO_term_id, '')
WHERE uniprot_accession='Q0PBI7';
...
VALUES
  ('Helicobacter pylori 26695', 'Helicobacter pylori 26695', NULL,
   0, NULL, 'TESTB',
   datetime('now'), (SELECT curator_id FROM core_curator ORDER BY curator_id LIMIT 1), (SELECT publication_id FROM core_publication WHERE pmid='24915082' LIMIT 1), datetime('now'), NULL);

INSERT INTO core_curation_TF_instances (curation_id, tfinstance_id)
SELECT (SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='24915082' LIMIT 1) ORDER BY curation_id DESC LIMIT 1), (SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='Q0PBI7' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_curation_TF_instances
  WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='24915082' LIMIT 1) ORDER BY curation_id DESC LIMIT 1) AND tfinstance_id=(SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='Q0PBI7' LIMIT 1)
);
...
SELECT
  (SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1),
  'WP_000431914.1',
  'cation:proton antiporter domain-containingprotein',
  492809,
  494059,
  -1,
  'HP_RS02330',
...
SELECT 'Alkaline phosphatase reporter assay', 'Alkaline phosphatase reporter assay', NULL, 'ECO:0005615'
WHERE NOT EXISTS (
  SELECT 1 FROM core_experimentaltechnique WHERE EO_term='ECO:0005615'
);
...
WHERE NOT EXISTS (
  ...
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
    AND start=75286 AND end=75293 AND strand=1
    AND _seq='ATTGCTGA'
);
...
VALUES
  ((SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='24915082' LIMIT 1) ORDER BY curation_id DESC LIMIT 1),
...
SELECT (SELECT id FROM core_curation_siteinstance
        WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='24915082' LIMIT 1) ORDER BY curation_id DESC LIMIT 1)
...
SELECT
  ...
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00340' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00345' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00350' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00355' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00360' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_siteinstance
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
    AND start=62279 AND end=62286 AND strand=1
    AND _seq='CTGACTGA'
);
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00295' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00300' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00305' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00310' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'exp_verified',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00315' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00320' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00325' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00330' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='HP_RS00335' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000915.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'inferred',
  NULL
WHERE (SELECT gene_id FROM core_gene
