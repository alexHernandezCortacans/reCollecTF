...
SELECT
  'ARTICLE',
  '42111652',
  'Gosling J, Warsame Dualeh E, Biggs J',
  ...
  '2026',
  'https://doi.org/10.1007/s00445-026-01984-8',
  0,
  1,
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_publication WHERE pmid='42111652'
);

UPDATE core_publication
SET
  authors = CASE WHEN authors IS NULL OR authors='' THEN 'Gosling J, Warsame Dualeh E, Biggs J' ELSE authors END,
  title = CASE WHEN title IS NULL OR title='' THEN 'Analysis and automatic detection of lava flows using SAR backscatter applied to the 2017 eruption of Erta ''Ale Volcano, Ethiopia.' ELSE title END,
  journal = CASE WHEN journal IS NULL OR journal='' THEN 'Bulletin of volcanology' ELSE journal END,
  publication_date = CASE WHEN publication_date IS NULL OR publication_date='' THEN '2026' ELSE publication_date END,
  url = CASE WHEN url IS NULL OR url='' THEN 'https://doi.org/10.1007/s00445-026-01984-8' ELSE url END,
...
SELECT
  'WP_003255133',
  'P0A171',
  'RNA polymerase factor sigma-54 [Pseudomonas putida KT2440].',
  (SELECT TF_id FROM core_tf WHERE lower(name)=lower('UmuDAb') LIMIT 1),
  ''
WHERE NOT EXISTS (
  SELECT 1 FROM core_tfinstance WHERE uniprot_accession='P0A171'
);

UPDATE core_tfinstance
SET
  TF_id = COALESCE(TF_id, (SELECT TF_id FROM core_tf WHERE lower(name)=lower('UmuDAb') LIMIT 1)),
  refseq_accession = COALESCE(NULLIF(refseq_accession,''), 'WP_003255133'),
  description = COALESCE(NULLIF(description,''), 'RNA polymerase factor sigma-54 [Pseudomonas putida KT2440].'),
  notes = COALESCE(notes, '')
WHERE uniprot_accession='P0A171';
...
PROVA',
   datetime('now'), (SELECT curator_id FROM core_curator ORDER BY curator_id LIMIT 1), (SELECT publication_id FROM core_publication WHERE pmid='42111652' LIMIT 1), datetime('now'), NULL);

INSERT INTO core_curation_TF_instances (curation_id, tfinstance_id)
SELECT (SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42111652' LIMIT 1) ORDER BY curation_id DESC LIMIT 1), (SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='P0A171' LIMIT 1)
WHERE NOT EXISTS (
  SELECT 1 FROM core_curation_TF_instances
  WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42111652' LIMIT 1) ORDER BY curation_id DESC LIMIT 1) AND tfinstance_id=(SELECT TF_instance_id FROM core_tfinstance WHERE uniprot_accession='P0A171' LIMIT 1)
);
...
SELECT 'Consensus search', 'Consensus search', NULL, 'ECO:0005624'
WHERE NOT EXISTS (
  SELECT 1 FROM core_experimentaltechnique WHERE EO_term='ECO:0005624'
);
...
WHERE NOT EXISTS (
  ...
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
    AND start=25758 AND end=25768 AND strand=1
    AND _seq='AAAAAAAAAAA'
);
...
VALUES
  ((SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42111652' LIMIT 1) ORDER BY curation_id DESC LIMIT 1),
...
SELECT (SELECT id FROM core_curation_siteinstance
        WHERE curation_id=(SELECT curation_id FROM core_curation WHERE publication_id=(SELECT publication_id FROM core_publication WHERE pmid='42111652' LIMIT 1) ORDER BY curation_id DESC LIMIT 1)
...
SELECT
  ...
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='JHP_RS00135' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_siteinstance
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
    AND start=95630 AND end=95639 AND strand=1
    AND _seq='GGGGGGGGGG'
);
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='JHP_RS00480' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'exp_verified',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='JHP_RS00485' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'exp_verified',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_siteinstance
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
    AND start=7526 AND end=7538 AND strand=1
    AND _seq='TTTTTTTTTTTTT'
);
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='JHP_RS00065' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'exp_verified',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
WHERE NOT EXISTS (
  SELECT 1 FROM core_siteinstance
  WHERE genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
    AND start=106943 AND end=106954 AND strand=1
    AND _seq='CCCCCCCCCCCC'
);
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='JHP_RS00525' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'exp_verified',
  NULL
WHERE (SELECT gene_id FROM core_gene
...
SELECT
  (SELECT id FROM core_curation_siteinstance
        ...
        ORDER BY id DESC LIMIT 1),
  (SELECT gene_id FROM core_gene
            WHERE locus_tag='JHP_RS00530' AND genome_id=(SELECT genome_id FROM core_genome WHERE genome_accession='NC_000921.1' LIMIT 1)
            ORDER BY gene_id DESC LIMIT 1),
  'exp_verified',
  NULL
WHERE (SELECT gene_id FROM core_gene
